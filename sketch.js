...
function setup(){
  ...
  ground = createSprite(width/2,height-9,600,10);
...
function draw(){
  ...
  textSize(30)
  text("score:"+score,50,height-800);
...
function spawnClouds(){
  if(frameCount % 60 === 0){
    ...
    cloud.velocityX = -5;
    cloud.lifetime = 120;
    cloud.y = Math.round(random(height/height,height-20));
...
function spawnObstacles(){
  if(frameCount % 120 === 0){
    var obstacle = createSprite(width,height-20,10,20);
